...
export class CompetitionService {
  ...
  finishCompetitionService(sportName, disciplineName, gender) {
    const data = {
      sportName: sportName,
      disciplineName: disciplineName,
      gender: gender
    ...
    return this.http.post(`${this.uri}/competitions/finishCompetition`, data);
  }

  fetchAllFinishedCompetitionsService() {
    return this.http.get(`${this.uri}/competitions/fetchAllFinishedCompetitions`);
  }
