...
export class TeamsFormationComponent implements OnInit {
  ...
  constructor(private router: Router, private sportService: SportService, private playerService: PlayerService, private nationalTeamsService: NationalTeamsService) { }
